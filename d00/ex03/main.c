...
int main(void)
{
	...
	printf("price for the art \'%s\' is %d\n", "NULL", searchPrice(dict, NULL));
	printf("price for the art \'%s\' is %d\n", "empty string", searchPrice(dict, ""));
	printf("price for the art \'%s\' is %d\n", "INTERIOR - WHITE MOUNTAINS", searchPrice(dict, "INTERIOR - WHITE MOUNTAINS")); //first element in file
	printf("price for the art \'%s\' is %d\n", "American Gothic", searchPrice(dict, "American Gothic")); //last element in file
